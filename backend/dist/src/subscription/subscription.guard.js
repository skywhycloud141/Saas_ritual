...
let SubscriptionGuard = class SubscriptionGuard {
    ...
    async canActivate(context) {
        ...
        if (!agency?.subscriptionUntil || agency.subscriptionUntil < new Date()) {
            throw new common_1.ForbiddenException(`Ваша подписка истекла, активируйте новый ключ для продолжения работы`);
        }
        return true;
    }
};
